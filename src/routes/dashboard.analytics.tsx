...
import { analyticsAPI, eventsAPI, photosAPI, getUserIdFromToken } from "@/lib/api/client";
...
function Analytics() {
  ...
  const TRAFFIC_BARS = [
    { date: "Mon", views: 120, label: "12" },
    { date: "Tue", views: 190, label: "19" },
    { date: "Wed", views: 150, label: "15" },
    { date: "Thu", views: 220, label: "22" },
    { date: "Fri", views: 280, label: "28" },
    { date: "Sat", views: 240, label: "24" },
    { date: "Sun", views: 200, label: "20" },
  ];
            ...
            {TRAFFIC_BARS.map((bar) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ height: `${(bar.views / 300) * 100}%`, minHeight: "20px" }}
                />
