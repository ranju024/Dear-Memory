        ...
        <section className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-5">
          <div className="bg-white rounded-2xl border border-[#e8e4de] p-6">
            <SectionHeader
              ...
              action={<button className="inline-flex items-center justify-center rounded-xl bg-white border border-[#e0dbd4] px-4 py-2 text-[13.5px] font-medium text-[#2d2a29] hover:bg-[#f4f1eb] transition-colors">View details</button>}
            />
            ...
            <div className="mt-6 flex items-end gap-3 h-44">
              {TRAFFIC_BARS.map((bar, index) => (
                <div key={bar.day} className="flex-1 flex flex-col items-center gap-3">
                  <div className={`w-full ${bar.heightClass} rounded-t-2xl bg-[#edf4f1] flex items-end overflow-hidden`}>
                    <div
                      className={`w-full rounded-t-2xl ${index === 5 ? "bg-[#4A7C6A]" : "bg-[#dbe8e2]"}`}
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-5">
          <div className="bg-white rounded-2xl border border-[#e8e4de] p-6">
            <SectionHeader
              ...
              action={<button className="inline-flex items-center justify-center rounded-xl bg-white border border-[#e0dbd4] px-4 py-2 text-[13.5px] font-medium text-[#2d2a29] hover:bg-[#f4f1eb] transition-colors">Open all</button>}
            />
