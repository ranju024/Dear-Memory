...
function StudioRow() {
  return (
    <div className="px-4 pb-5 pt-3 flex items-center gap-3">
      {/* Avatar — initials on warm stone, no colored circle */}
      <div
        className="w-8 h-8 rounded-full bg-[#e8e4de] shrink-0 grid place-items-center text-[11px] font-semibold tracking-wide text-[#5c5753]"
        aria-hidden
      >
        IM
      </div>
      <div className="flex-1 min-w-0">
        <p className="text-[13px] font-semibold text-[#2d2a29] truncate leading-snug">Inês M.</p>
        <p className="text-[11.5px] text-[#a09c98] truncate leading-snug">Goldenhour Studio</p>
      </div>
    </div>
  );
}
