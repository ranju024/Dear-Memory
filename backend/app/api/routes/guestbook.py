...
async def list_pending_entries(event_id: int, token: str, db: Session = Depends(get_db)):
...
async def approve_entry(event_id: int, entry_id: int, token: str, db: Session = Depends(get_db)):
...
async def delete_entry(event_id: int, entry_id: int, token: str, db: Session = Depends(get_db)):
